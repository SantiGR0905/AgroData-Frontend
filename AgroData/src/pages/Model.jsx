...
import '../styles/Model.css'; // Archivo de estilos para esta página
      ...
      <div className="model-grid">
        ...
        <div className="model-card">
          ...
          <div className="model-content">
            ...
            <p>
              Esta mapa muestra las ubicaciones de las granjas en las que se implementa el sistema de cultivos.
            </p>
        ...
        {/* Segunda imagen con descripción */}
